...
import TermsAndConditions from '@/app/(main)/tours/[slug]/TermsAndConditions'
...
const TourType: {slug: string; name: string; popular: boolean}[] = [
  {
    name: 'Motorbike Tour',
    slug: 'motorbike_tour',
    popular: true,
...
const TourPackage: {slug: string; name: string}[] = [
  {name: 'Saving Package', slug: 'saving_package'},
  {name: 'Budget Package', slug: 'budget_package'},
  {name: 'Premium Package', slug: 'premium_package'},
]
      ...
      <div className='rounded-[1.5rem] border border-solid border-[#ededed] bg-white p-[1.5rem]'>
        <div className='mb-[1rem] flex items-center justify-between border-b border-solid border-[#EDEDED] pb-[0.625rem]'>
          ...
          <button
            ...
            className='inline-flex cursor-pointer items-center space-x-[0.5rem] rounded-[0.5rem] border border-solid border-[#ECECEC] px-[1rem] py-[0.5rem]'
          >
            ...
            <Image
              ...
              width={20}
              height={20}
              src={'/tours/chevron-right-double.svg'}
              ...
              <div className='flex-1 self-stretch rounded-[0.75rem] bg-[#F1F8F8] p-[1rem]'>
                ...
                >
                  <ul>
                    <li>
                      Accommodations :{' '}
                      <strong>luxurious private homestay rooms</strong>,
                      included one dormitory on arrival night (can be upraded
                      with small fee)
                    </li>
                    <li>
                      Accommodations :{' '}
