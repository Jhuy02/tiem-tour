...
export default function ContactInformation() {
    ...
    return (
        <div className="rounded-[1.5rem] border-[1px] border-solid border-[#EDEDED] bg-white p-[1.875rem_1.75rem]">
            ...
            <div className="flex space-x-[0.75rem] w-full">
                <FormField
                    control={control}
                    name="yourName"
                    render={({field}) => (
                        <FormItem className="gap-0 space-y-[0.63rem] w-full flex flex-col">
                            ...
                            <FormControl>
                                <Input
                                    ...
                                    className="focus-visible:border-[#25ACAB] hover:border-[#25ACAB] transition-all duration-300 focus-visible:ring-0 p-[1rem] h-[3.0625rem] rounded-[0.75rem] border-[1px] border-solid border-[#EDEDED] bg-[#FFF] text-[#2E2E2E] font-trip-sans text-[0.875rem] font-medium tracking-[0.00219rem] leading-[1.2]"
                                />
                            </FormControl>
                    ...
                    <FormItem className="gap-0 space-y-[0.63rem] w-full flex flex-col mt-[0.75rem]">
                        ...
                        <FormControl>
                            <Textarea
                                ...
                                className="resize-none focus-visible:border-[#25ACAB] hover:border-[#25ACAB] transition-all duration-300 focus-visible:ring-0 p-[1rem] h-[6.8125rem] rounded-[0.75rem] border-[1px] border-solid border-[#EDEDED] bg-[#FFF] text-[#2E2E2E] font-trip-sans text-[0.875rem] font-medium tracking-[0.00219rem] leading-[1.2]"
                            />
                        </FormControl>
                        <FormMessage className='font-trip-sans pl-[0.125rem] text-[0.75rem] leading-[120%] font-bold tracking-[0.00188rem] text-[#EA3434]' />
                    </FormItem>
