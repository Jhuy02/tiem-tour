    ...
    <Dialog>
      ...
      <DialogContent className='z-150 w-[56.0625rem] max-w-[80vw]! overflow-hidden rounded-[1.5rem]! border-none! bg-transparent p-0!'>
        <DialogHeader className='hidden'>
          <DialogTitle>TIEM TOURS HA GIANG TERMS AND CONDITIONS</DialogTitle>
        ...
        <div className='relative z-2 h-[42.75rem] max-h-[80vh] overflow-hidden bg-[#FAFAFA]'>
          ...
          <div className='relative z-1 max-h-full overflow-y-auto px-[1.5rem] pt-[1.5rem]'>
                    ...
                    return (
                      ...
                      >
                        ...
                        <p className='text-[0.875rem] leading-[150%] tracking-[0.00219rem] text-[#303030]'>
                          ...
                          guarantee the tour. Any request might change due to
                          the availability of each day.
                        </p>
                      </div>
                    )
                  })}
                  ...
                  {[...Array(4)].map((_, index) => {
                    return (
                      ...
                      >
                        ...
                        />
                        <p className='text-[0.875rem] leading-[150%] tracking-[0.00219rem] text-[#303030]'>
                          In the event of cancellation, no refunds will be
                          issued for the deposit or full payment tour regardless
            ...
            <div className='pb-[1.5rem]'>
              ...
              culpa nobis, voluptatibus consectetur amet aperiam eveniet? Quo
              illo earum consectetur corrupti dolorem rerum voluptate, hic
              tempore fugit perferendis amet distinctio quisquam exercitationem
              magni accusamus aut nulla repudiandae cum ex beatae deserunt
              dolores! Alias aspernatur ex quibusdam. Rem est ipsa
              necessitatibus ipsam labore eum possimus, blanditiis architecto
              aperiam recusandae natus, magnam, itaque deserunt totam sit
              inventore. Dignissimos rerum explicabo possimus aliquam! Ut
              tempora nam voluptate expedita commodi. Assumenda deleniti error
              necessitatibus, voluptatibus dolorem quisquam. Veritatis libero
              inventore soluta tenetur delectus atque in magnam. Tempore quidem
            </div>
          </div>
        </div>
      </DialogContent>
