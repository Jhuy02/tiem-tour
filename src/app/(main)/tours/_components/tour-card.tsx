import {IDuration, ILocation} from '@/app/(main)/tours/section-best-choose'
...
export default function TourCard({
  ...
  return (
    <article className='group w-full h-[25.8125rem] overflow-hidden bg-[#fff] max-sm:h-auto cursor-pointer'>
      ...
      <div className='relative py-[1rem] px-[0.75rem]'>
        <h3 className='text-[#3b3943] font-dvn-luckiest-guy text-[1.125rem] font-normal leading-[120%] tracking-[0.0125rem] uppercase h-[2.75rem] line-clamp-2 mb-[0.75rem] max-sm:text-[1rem] max-sm:mb-[0.5rem]'>
          {title}
        </h3>
